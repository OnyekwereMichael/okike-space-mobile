...
/>
      ...
      <View className="border border-[#F0EEF1] rounded-[12px] h-[184px] p-5 flex justify-center items-center ">
        <View className="flex-row items-center gap-4 w-full">
          ...
          <View className="">
            <Text className="text-[20px] font-Clash-Bold text-[#1C0067]">Selfie Check</Text>
        ...
        >
          <Text className="font-semibold text-[#1C0067] text-[18px] font-Clash-Semibold justify-center">
            Take Selfie
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="absolute bottom-10 left-6 right-6">
        ...
        <View className="items-center mb-4">
               <StepTracker totalSteps={5} currentStep={5}  textColor="#1C0067"
            activeColor="#1C0067"
