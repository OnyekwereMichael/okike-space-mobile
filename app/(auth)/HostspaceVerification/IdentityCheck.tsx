  ...
  return (
    <SafeAreaView className="flex-1 justify-center items-center bg-[#F8F9FA] px-6">
      <View className="mb-6 bg-[#E0E0E0] w-24 h-24 rounded-full justify-center items-center">
        <Ionicons name="camera-outline" size={48} color="#023327" />
      </View>

      {/* Heading */}
      <Text className="text-2xl font-Clash-Bold text-[#023327] text-center mb-2">
      ...
      <TouchableOpacity
        ...
        className="bg-[#023327] px-8 py-3 rounded-full shadow-md"
        style={{
          shadowColor: "#000",
      ...
      <View className="border border-[#F0EEF1] rounded-[12px] h-[184px] p-5 flex justify-center items-center">
        {selfieUri ? (
          ...
          <>
            ...
            >
              <Text className="font-semibold text-[#023327] text-[18px] font-Clash-Semibold">
                Take Selfie
              </Text>
            </TouchableOpacity>
          </>
